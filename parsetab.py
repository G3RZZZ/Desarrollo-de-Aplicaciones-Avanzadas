...
_lr_productions = [
  ...
  ('top_level -> top_level_expr','top_level',1,'p_top_level','lex.py',146),
  ('top_level -> top_level_expr top_level','top_level',2,'p_top_level','lex.py',147),
  ('top_level_expr -> assignment newline','top_level_expr',2,'p_top_level_expr','lex.py',153),
  ('top_level_expr -> function_definition newline','top_level_expr',2,'p_top_level_expr','lex.py',154),
  ('top_level_expr -> expression newline','top_level_expr',2,'p_top_level_expr','lex.py',155),
  ('assignment -> VARIABLE SETTO expression','assignment',3,'p_assignment_assign','lex.py',161),
  ('assignment -> VARIABLE SETTO flow','assignment',3,'p_assignment_flow','lex.py',176),
  ('flow -> VARIABLE CONNECT flow_functions','flow',3,'p_flow_form','lex.py',191),
  ('flow_functions -> flow_function_call CONNECT flow_functions','flow_functions',3,'p_flow_functions','lex.py',208),
  ('flow_functions -> flow_function_call','flow_functions',1,'p_flow_function','lex.py',222),
  ('flow_function_call -> VARIABLE DOT LPAREN params RPAREN','flow_function_call',5,'p_flow_function_call','lex.py',228),
  ('assignment -> expression','assignment',1,'p_assignment_expression','lex.py',243),
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','lex.py',249),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','lex.py',264),
  ('expression -> term','expression',1,'p_expression_term','lex.py',279),
  ('expression -> string','expression',1,'p_expression_term','lex.py',280),
  ('string -> STRING','string',1,'p_string','lex.py',286),
  ('term -> term TIMES exponent','term',3,'p_term_times','lex.py',292),
  ('term -> term DIVIDE exponent','term',3,'p_term_divide','lex.py',308),
  ('term -> exponent','term',1,'p_term_exponent','lex.py',324),
  ('exponent -> factor EXP factor','exponent',3,'p_exponent_ext','lex.py',330),
  ('exponent -> factor','exponent',1,'p_exponent_factor','lex.py',346),
  ('exponent -> LPAREN expression RPAREN','exponent',3,'p_exponent_paren','lex.py',352),
  ('factor -> NUMBER','factor',1,'p_factor_num','lex.py',364),
  ('factor -> VARIABLE','factor',1,'p_factor_id','lex.py',372),
  ('factor -> function_call','factor',1,'p_factor_function_call','lex.py',381),
  ('function_call -> VARIABLE DOT LPAREN params RPAREN','function_call',5,'p_function_call','lex.py',387),
  ('params -> params COMMA expression','params',3,'p_params','lex.py',397),
  ('params -> expression','params',1,'p_params','lex.py',398),
  ('params -> empty','params',1,'p_params','lex.py',399),
  ('function_definition -> VARIABLE LPAREN args RPAREN LBRACE newline statements newline RBRACE','function_definition',9,'p_function_definition','lex.py',422),
  ('statements -> statement','statements',1,'p_statements','lex.py',458),
  ('statements -> statements newline statement','statements',3,'p_statements','lex.py',459),
  ('statement -> assignment','statement',1,'p_statement','lex.py',468),
  ('empty -> <empty>','empty',0,'p_empty','lex.py',473),
  ('args -> VARIABLE COMMA args','args',3,'p_args','lex.py',478),
  ('args -> VARIABLE','args',1,'p_args','lex.py',479),
  ('args -> empty','args',1,'p_args','lex.py',480),
]
